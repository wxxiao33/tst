...
class HistoriesTest < ApplicationSystemTestCase
  ...
  test "creating a History" do
    ...
    fill_in "Boolean", with: @history.boolean
    fill_in "Challenge", with: @history.challenge_id
    fill_in "Continuous check in", with: @history.continuous_check_in
    fill_in "Finished", with: @history.finished
